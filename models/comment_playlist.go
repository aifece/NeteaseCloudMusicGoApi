...
func (m *MusicObain) CommentPlaylist(query map[string]interface{}) map[string]interface{} {
	...
	return request.CreateRequest(
		"POST", "https://music.163.com/weapi/v1/resource/comments/A_PL_0_"+fmt.Sprintf("%v", query["id"]),
		data,
		options)
}

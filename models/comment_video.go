...
func (m *MusicObain) CommentVideo(query map[string]interface{}) map[string]interface{} {
	...
	return request.CreateRequest(
		"POST", "https://music.163.com/weapi/v1/resource/comments/R_VI_62_"+fmt.Sprintf("%v", query["id"]),
		data,
		options)
}
